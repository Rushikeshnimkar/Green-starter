...
const CreateProposal = () => {
  ...
  return (
    <div className="flex justify-center   bg-white">
      <div className="text-sm mt-8  py-8 px-8 max-w-lg rounded-md border mb-6  shadow-lg  shadow-[#263A05] ">
            ...
            {({ isSubmitting, setFieldValue, values }) => (
              <Form>
                ...
                <div className="flex justify-center mt-5">
                  <Button
                    className="flex justify-center bg-[#263A05]"
                    variant="primary"
                    size="md"
                    type="submit"
